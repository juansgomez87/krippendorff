...
This code has been taken from https://github.com/pln-fing-udelar/fast-krippendorff and modified
...
def alpha(reliability_data=None, value_counts=None, value_domain=None, level_of_measurement='interval',
    ...
    dist = _distances(value_domain, distance_metric, n_v)

    # conversion to fit manual calculations
